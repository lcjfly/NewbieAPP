...
var AboutTab = require('./AboutTab.ios.js');
    ...
    return (
      <TabBarIOS>
        ...
        <TabBarIOS.Item
          ...
          selected={this.state.selectedTab === 'starTab'}
          onPress={() => {
            this.setState({
              selectedTab: 'starTab',
            });
          }}>
          {this._renderContent('#783E33', 'star Tab')}
        </TabBarIOS.Item>
        <TabBarIOS.Item
          title="消息"
          ...
          {this._renderContent('#414A8C', 'msg Tab', this.state.notifCount)}
        </TabBarIOS.Item>
        <TabBarIOS.Item
          title="搜索"
          ...
          {this._renderContent('#21551C', 'Search Tab', this.state.presses)}
        </TabBarIOS.Item>
        <TabBarIOS.Item
          title="关于"
