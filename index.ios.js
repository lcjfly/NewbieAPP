        ...
        {this.state.isIndexShow ?
          <View style={{flex: 1, opacity: 1}}>
            <TabBarIOS>
              <TabBarIOS.Item
                title="首页1"
                icon={{uri: base64Icon_home_negtive, scale: 2.0}}
                selectedIcon={{uri: base64Icon_home_active, scale: 2.0}}
              ...
              <TabBarIOS.Item
                title="收藏"
                icon={{uri: base64Icon_star_negtive, scale: 2.0}}
                selectedIcon={{uri: base64Icon_star_active, scale: 2.0}}
              ...
              <TabBarIOS.Item
                title="搜索"
                icon={{uri: base64Icon_search_negtive, scale: 2.0}}
                selectedIcon={{uri: base64Icon_search_active, scale: 2.0}}
              ...
              <TabBarIOS.Item
                title="消息"
                icon={{uri: base64Icon_menu_negtive, scale: 2.0}}
                selectedIcon={{uri: base64Icon_menu_active, scale: 2.0}}
              ...
              <TabBarIOS.Item
                title="设置"
                icon={{uri: base64Icon_settings_negtive, scale: 2.0}}
                selectedIcon={{uri: base64Icon_settings_active, scale: 2.0}}
